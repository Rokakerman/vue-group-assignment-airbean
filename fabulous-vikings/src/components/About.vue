    ...
    <div class="about">
        ...
        <main class="about-main">
            <p class="strong-bread"> 
                ...
                strong whipped, variety extra iced id lungo half and half mazagran. Pumpkin spice.
            </p>
            <p class="bread">
                ...
                <br> <br>
                Roast id macchiato, 
                single shot siphon mazagran milk fair trade est aroma a half and half and, so, 
